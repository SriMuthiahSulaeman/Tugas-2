...
public class JavaApplication_SriMuthiahSulaeman {

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Scanner sc = new Scanner(System.in);
        Integer pilihan = 0;
        int harga_item[] = {25000, 25000, 15000,19000 };
        String menu = null;
        int pembayaran;
        ...
        System.out.println("-------------------------------------------------");   
        System.out.println("| 1. Americano                |   Rp 25000      |");
        System.out.println("| 2. Arabika                  |   Rp 25000      |");
        System.out.println("| 3. Latte                    |   Rp 15000      |");
        System.out.println("| 4. Matcha                   |   Rp 19000      |");
